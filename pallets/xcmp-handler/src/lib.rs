...
use staging_xcm::{latest::InteriorLocation, prelude::*};
...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn get_instruction_set(
            ...
            (
                staging_xcm::latest::Xcm<<T as pallet::Config>::RuntimeCall>,
                staging_xcm::latest::Xcm<()>,
            ),
            DispatchError,
        > {
        ...
        > {
            ...
            let (local_xcm, target_xcm) = if reserve == Location::here() {
        ...
        pub fn transact_in_local_chain(
            ...
            let mut hash = internal_instructions.using_encoded(sp_io::hashing::blake2_256);
        ...
        pub fn transact_in_target_chain(
            ...
            let destination_location = Location::new(1, Here);
